...
import BpmVerificationClient from './BpmVerificationClient'

export const dynamic = 'force-dynamic'

export default async function BpmVerificationPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col p-4 sm:p-8 bg-transparent">
      <div className="max-w-5xl mx-auto flex-1 w-full">
        <PageHeader
          subtitle="ChatGPT verification"
          breadcrumbs={[
            { label: 'Home', href: '/' },
            { label: 'Admin', href: '/admin' },
            { label: 'BPM Verification' },
          ]}
        />
        <BpmVerificationClient />
      </div>
