  ...
  return (
    <main className="flex min-h-screen flex-col p-4 sm:p-8 bg-transparent">
      <div className="max-w-7xl mx-auto flex-1 w-full">
        ...
        <div className="rounded-2xl bg-white p-6 border border-gray-100 sm:p-10 dark:border-slate-800 dark:bg-slate-900">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
              <Link
                ...
                className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-gradient-to-br from-white via-white to-emerald-50/30 p-6 sm:p-8 transition hover:-translate-y-0.5 dark:border-slate-800 dark:from-slate-900 dark:via-slate-900 dark:to-emerald-500/10"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-3">
                    <div className="inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-emerald-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-emerald-700 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-300">
                  ...
                  <div className="hidden sm:flex h-11 w-11 items-center justify-center rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-300">
              ...
              <Link
                href="/credits"
                className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-gradient-to-br from-white via-white to-slate-50 p-6 sm:p-8 transition hover:-translate-y-0.5 dark:border-slate-800 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800/80"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-3">
                    <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-100 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-600 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200">
                      Credit Search Tools
                    </div>
            ...
            <div className="space-y-3 text-xs text-gray-400 dark:text-slate-500">
              <p>
                Due to{' '}
                <a
