      ...
      <div className="max-w-7xl mx-auto flex-1 w-full">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            Due to <a href="https://developer.spotify.com/blog/2025-04-15-updating-the-criteria-for-web-api-extended-access" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 underline">new policies</a> from Spotify that prevent community developments, this app is open only to a few authorized users. If you are interested in using it, please email me at{' '}
            <a href="mailto:delman@delman.it" className="text-green-600 hover:text-green-700 underline">
              delman@delman.it
            </a>
            .
            </p>
          ...
          <div className="mt-8 p-4 bg-white/50 rounded-lg max-w-lg mx-auto">
